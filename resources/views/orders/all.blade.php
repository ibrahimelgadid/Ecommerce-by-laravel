            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <a href="/order/done/{{$order->id}}" class="done"><i class="fa fa-thumbs-down text-danger"></i></a>
                        @endif
                    </td>
                    <td>
                        ...
                        <a href="/orders/{{$order->id}}" class="btn btn-info btn-sm text-white py-0"><i class="fa fa-info"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
