...
<div class="text-center mt-4">
        ...
        <table class="table my-4 table-dark table-responsive-sm searched">
            ...
            <tbody>
                ...
                <td>
                    @if ($member->active==1)
                        <a class="btn btn-sm btn-success" href="/members/inActivate/{{$member->id}}"><i class="fa fa-thumbs-up"></i></a>
                    @else
                        <a  class="btn btn-sm btn-secondary" href="/members/activate/{{$member->id}}"><i class="fa fa-thumbs-down"></i></a>
                    @endif
